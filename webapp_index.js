// Read Receipts Plugin - Minimal Webapp
var PLUGIN_ID = 'com.custom.read-receipts';
var readReceiptsStore = {};
var lastScannedChannel = null;
...
export default class Plugin {
    initialize(registry, store) {
        ...
        // Notify server on channel switch + scan for checkmarks
        // Use channel_viewed websocket event instead of store.subscribe
        registry.registerWebSocketEventHandler(
            'channel_viewed',
            function(msg) {
        ...
        // Also handle posted event to add checkmarks to new own messages
        registry.registerWebSocketEventHandler(
            'posted',
            function() {
                debouncedScan();
        ...
        // One-time initial scan after page loads
        setTimeout(scan, 4000);

        // Periodic light scan every 10 seconds
